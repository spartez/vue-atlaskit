import { pushScopeId, popScopeId, openBlock, createBlock, renderSlot, withScopeId, resolveComponent, withCtx, createVNode, createCommentVNode, resolveDynamicComponent, TransitionGroup, Fragment, renderList, Transition, toDisplayString } from 'vue';
import { s as script$b } from './Tooltip-2e49f333.js';
import { s as script$a } from './DropdownItem-e9305055.js';
import { s as script$9 } from './Dropdown-1e944714.js';

var script = {
  name: 'PresenceWrapper'
};

const _withId = /*#__PURE__*/withScopeId("data-v-4196f35d");

pushScopeId("data-v-4196f35d");
...
const render = /*#__PURE__*/_withId((_ctx, _cache, $props, $setup, $data, $options) => {
  return openBlock(), createBlock("span", _hoisted_1, [renderSlot(_ctx.$slots, "default")]);
});
...
const _hoisted_1$1 = /*#__PURE__*/createVNode("svg", {
  height: "100%",
  version: "1.1",
  viewBox: "0 0 8 8",
  width: "100%",
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_PresenceWrapper = resolveComponent("PresenceWrapper");

  return openBlock(), createBlock(_component_PresenceWrapper, null, {
...
const _hoisted_1$3 = /*#__PURE__*/createVNode("svg", {
  height: "100%",
  version: "1.1",
  viewBox: "0 0 8 8",
  width: "100%",
  ...
  cy: "4",
  r: "4"
}), /*#__PURE__*/createCommentVNode("eslint-disable-next-line max-len"), /*#__PURE__*/createVNode("path", {
  fill: "#ffF",
...
const _hoisted_1$4 = /*#__PURE__*/createVNode("svg", {
  height: "100%",
  version: "1.1",
  viewBox: "0 0 8 8",
  width: "100%",
...
const _withId$1 = /*#__PURE__*/withScopeId("data-v-02129e7c");

pushScopeId("data-v-02129e7c");

const _hoisted_1$5 = /*#__PURE__*/createVNode("svg", {
  height: "100%",
  version: "1.1",
  viewBox: "0 0 8 8",
  width: "100%",
...
const _withId$2 = /*#__PURE__*/withScopeId("data-v-8f2c9a8e");

pushScopeId("data-v-8f2c9a8e");
...
const _withId$3 = /*#__PURE__*/withScopeId("data-v-100e3b6f");

pushScopeId("data-v-100e3b6f");
...
const _hoisted_2 = /*#__PURE__*/createVNode("g", null, [/*#__PURE__*/createVNode("circle", {
  cx: "64",
  cy: "64",
  r: "64",
  fill: "rgb(193, 199, 208)"
}), /*#__PURE__*/createVNode("g", null, [/*#__PURE__*/createCommentVNode("eslint-disable-next-line max-len"), /*#__PURE__*/createVNode("path", {
...
const render$7 = /*#__PURE__*/_withId$3((_ctx, _cache, $props, $setup, $data, $options) => {
  return openBlock(), createBlock("div", {
  ...
  }, [renderSlot(_ctx.$slots, "avatar-header"), (openBlock(), createBlock(resolveDynamicComponent($props.tag), {
    href: $props.link,
    target: "_blank",
    class: "wrapper",
    size: $props.size,
    ...
    default: _withId$3(() => [$props.avatar && !$data.error ? (openBlock(), createBlock("img", {
      key: 0,
      draggable: "false",
      src: $props.avatar,
      alt: "avatar",
    ...
    , ["src"])) : (openBlock(), createBlock("svg", _hoisted_1$7, [_hoisted_2])), $props.status ? (openBlock(), createBlock(resolveDynamicComponent($props.status), {
      key: 2,
      class: "status",
      size: $props.size
    }, null, 8
    /* PROPS */
    , ["size"])) : createCommentVNode("v-if", true), $props.presence ? (openBlock(), createBlock(resolveDynamicComponent($props.presence), {
      key: 3,
      size: $props.size,
      class: "presence",
      "primary-color": "green"
    ...
    /* PROPS */
    , ["size"])) : createCommentVNode("v-if", true), renderSlot(_ctx.$slots, "avatar-footer")]),
    _: 3
    /* FORWARDED */
...
const _withId$4 = /*#__PURE__*/withScopeId("data-v-19485200");

pushScopeId("data-v-19485200");
...
const render$8 = /*#__PURE__*/_withId$4((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  return openBlock(), createBlock("div", _hoisted_1$8, [createVNode(TransitionGroup, {
    name: "participant",
    tag: "div",
    ...
    default: _withId$4(() => [_ctx.$slots.before ? (openBlock(), createBlock("div", {
      key: "slot-before",
      class: "avatar-wrapper",
      style: {
        zIndex: $options.count + 1
      }
    }, [renderSlot(_ctx.$slots, "before")], 4
    /* STYLE */
    )) : createCommentVNode("v-if", true), (openBlock(true), createBlock(Fragment, null, renderList($options.visible, (user, i) => {
      return openBlock(), createBlock("div", {
        key: user.key,
        class: "avatar-wrapper",
        "data-index": i,
        ...
        default: _withId$4(() => [createVNode(_component_Avatar, {
          key: user.key,
    ...
    /* KEYED_FRAGMENT */
    )), $options.isOverLimit ? (openBlock(), createBlock(_component_Dropdown, {
      key: "dropdown",
      ...
      trigger: _withId$4(({
        ...
        default: _withId$4(() => [(openBlock(), createBlock("span", {
          key: $options.collapsedCount,
          class: "collapsed-count"
        }, "+" + toDisplayString($options.collapsedCount), 1
        /* TEXT */
        ))]),
        _: 1
        /* STABLE */
      ...
      /* PROPS */
      , ["size", "open"])]),
      default: _withId$4(() => [(openBlock(true), createBlock(Fragment, null, renderList($options.collapsed, collapsedUser => {
        return openBlock(), createBlock(_component_DropdownItem, {
          key: collapsedUser.key
        }, {
          default: _withId$4(() => [collapsedUser.link ? (openBlock(), createBlock("a", {
            key: 0,
            class: "list-item",
          ...
          /* PROPS */
          , ["link", "status", "avatar", "presence"]), createVNode("span", _hoisted_2$1, toDisplayString(collapsedUser.displayName), 1
          /* TEXT */
          )], 8
          /* PROPS */
          , ["href"])) : (openBlock(), createBlock("div", _hoisted_3, [createVNode(_component_Avatar, {
            tag: "a",
            link: collapsedUser.link,
            class: "user-list-avatar",
            size: "small",
          ...
          /* PROPS */
          , ["link", "status", "avatar", "presence"]), createVNode("span", _hoisted_4, toDisplayString(collapsedUser.displayName), 1
          /* TEXT */
          )]))]),
          _: 2
          /* DYNAMIC */
    ...
    /* PROPS */
    , ["position-fixed", "append-to-body"])) : createCommentVNode("v-if", true)]),
    _: 1
    /* STABLE */
...
export { script$8 as a, script$7 as s };
