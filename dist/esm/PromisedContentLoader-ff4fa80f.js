import { pushScopeId, popScopeId, resolveComponent, openBlock, createBlock, renderSlot, createVNode, toDisplayString, resolveDynamicComponent, withScopeId } from 'vue';
import { i as isPromise } from './utils-b1fbbc31.js';
import { s as script$1 } from './ContentLoader-d7fea46c.js';
...
const _withId = /*#__PURE__*/withScopeId("data-v-74b6250f");

pushScopeId("data-v-74b6250f");
...
const render = /*#__PURE__*/_withId((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  const _component_Promised = resolveComponent("Promised");

  return $options.isPromise($props.value) ? (openBlock(), createBlock(_component_Promised, {
    key: 0,
    promise: $props.value,
    ...
    combined: _withId(({
      ...
      data,
      error
    }) => [isDelayOver && isPending ? (openBlock(), createBlock(_component_ContentLoader, {
      key: 0,
      width: $props.width,
      height: $props.height,
      ...
      default: _withId(() => [renderSlot(_ctx.$slots, "loader-shape", {}, () => [createVNode("rect", {
        x: "0",
        y: "0",
        rx: $props.height / 2,
        ry: $props.height / 2,
    ...
    /* PROPS */
    , ["width", "height", "preserve-aspect-ratio", "view-box"])) : error ? renderSlot(_ctx.$slots, "error-message", {
      key: 1
    }, () => [createVNode("div", _hoisted_1, toDisplayString(error.message), 1
    /* TEXT */
  ...
  /* PROPS */
  , ["promise", "pending-delay"])) : (openBlock(), createBlock(resolveDynamicComponent($props.tag), {
    key: 1
  }, {
